...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', help='path to images (should be used for unaligned datasets)')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='aligned_adv', help='chooses how datasets are loaded. [unaligned | aligned | single | aligned_adv]')
        ...
        parser.add_argument('--load_iter', type=int, default=0, help='which iteration to load? if load_iter > 0, the code will load models by iter_[load_iter]; otherwise, it will load models by [epoch]')
...
# You will also need a small util function `mkdirs`
# Add this to your `util/util.py` file if it's not there
